    ...
    try {
        ...
        const formattedStatistics = statistics.map((stat) => {
            ...
            return {
                ...
                title: (event === null || event === void 0 ? void 0 : event.title) || "Unknown Event", // Menyertakan title
                startTime: (event === null || event === void 0 ? void 0 : event.startTime) || "Unknown Time", // Menyertakan startTime
