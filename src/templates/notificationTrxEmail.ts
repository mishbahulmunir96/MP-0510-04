...
export const notificationTrxEmail = (data: {
  userName: string;
                              ...
                              <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                  <tr>
                                      <td style="padding: 0 0 36px 0; color: #153643;">
                                          ...
                                          <p style="margin: 0 0 12px 0; font-size: 16px; line-height: 24px;">Dear ${
                                            data.userName
                                          },</p>
                                                      ...
                                                      <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                                          <tr>
                                                              <td style="padding: 0 0 10px 0;">
                                                                  <p style="margin: 0; font-size: 16px; line-height: 24px;"><strong>Transaction ID:</strong> ${
                                                                    data.transactionID
                                                                  }</p>
                                                              </td>
                                                          </tr>
                                                          <tr>
                                                              <td style="padding: 0 0 10px 0;">
                                                                  <p style="margin: 0; font-size: 16px; line-height: 24px;"><strong>Amount:</strong> ${
                                                                    data.amount
                                                                  }</p>
                                                              </td>
                                                          </tr>
                                                          <tr>
                                                              <td style="padding: 0 0 10px 0;">
                                                                  <p style="margin: 0; font-size: 16px; line-height: 24px;"><strong>Date:</strong> ${
                                                                    data.date
                                                                  }</p>
                                                              </td>
                                                          </tr>
